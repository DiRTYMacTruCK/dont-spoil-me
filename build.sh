...
echo ""
echo "Next steps:"
echo "  1. Jellyfin dashboard → Plugins → confirm 'dont-spoil-me' is listed"
echo "  2. Dashboard → Scheduled Tasks → Refresh Metadata"
echo "  3. Configure at Dashboard → Plugins → dont-spoil-me"
